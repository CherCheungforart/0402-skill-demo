    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center py-8 font-sans">
      ...
      >
        ...
        <div 
          ...
          className={`flex-1 overflow-y-auto px-4 pb-[110px] pt-4 space-y-5 scrollbar-hide scroll-smooth transition-transform duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] ${isDrawerOpen ? '-translate-y-[180px]' : 'translate-y-0'}`}
        >
        ...
        {/* Bottom Input Area */}
        <div className="absolute bottom-0 w-full bg-[#F6F7F9] z-20 transition-all duration-300" style={{ transform: isDrawerOpen ? 'translateY(-180px)' : 'translateY(0)' }}>
